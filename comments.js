...
(function(){
  ...
  const TOP_GENERIC = [
    ...
    { text:"윤도겸 님 그냥 저 데려가시면 안 될까요 진지하게 여쭤봅니다",
      replies:["줄 서세요 저부터입니다","한서준씨 자리 비켜주실 수 있나요"] },
    { text:"작가님 자수하세요 이렇게 잘 쓰면 반칙이잖아요",
      replies:["인정합니다 이건 심의 들어가야 함","저도 신고하고 싶은데 계속 보게 됨"] },
    { text:"부계정 만들어서 또 정주행함 이거 실화냐 나",
      replies:["저도 부계 하나 더 팠습니다 동지가 있었네요","본계 부계 다 여기 있으면 어떡함"] },
    { text:"손목 잡는 장면 아직도 눈에 선함 어제 잘 때도 생각났어요",
      replies:["저는 꿈에 나왔습니다 진짜로","이 정도면 후유증 아닌가요"] },
    { text:"친구한테 이 소설 얘기하다가 실제로 소리 지름 옆에서 놀람",
      replies:["저희 집 강아지도 저 놀랐어요 ㅋㅋㅋ","목소리 커진 거 이해합니다 저도 그럼"] },
    { text:"이 소설 읽다가 현생 남친이 갑자기 부족해 보이기 시작함 죄송합니다",
      replies:["저도 그 죄책감 알아요","남친분한테는 비밀로 하세요 부디"] },
    { text:"댓글 쓰다 말고 다시 처음부터 읽으러 갑니다 이만 총총",
      replies:["저도 방금 그러고 왔어요 두 번째임","이 소설은 재독 유발 물질이 들어있음"] },
    { text:"작가님 통장에 별풍선 쏘고 싶은데 여기선 못 쏘니까 댓글로 백 개 대신 답니다",
      replies:["저도 만원씩 후원하고 싶은 심정임","댓글 별풍선 저도 동참합니다"] },
    { text:"이거 완전 취향저격이라 알림 다 켜놓고 화목만 기다리는 사람이 되어버림",
      replies:["화목병 저도 걸렸습니다 같이 앓아요","캘린더에 표시까지 해놨어요 저"] },
  ];
  ...
  const MID_GENERIC = [
    ...
    { text:"윤도겸 저기요 저 좀 봐주시면 안 될까요 한서준씨한테 미안하지만",
      replies:["줄 서주세요 저도 대기중입니다"] },
    { text:"오늘 하루 종일 회사에서 이 소설 생각만 함 일이 손에 안 잡힘",
      replies:["저도 회의 중에 딴생각 함 죄송합니다"] },
    { text:"이 소설 알게 된 거 이번 달 최고의 행운임",
      replies:["저도 완전 동의합니다 행운 그 자체"] },
    { text:"한서준 반응 볼 때마다 나 대신 당해주는 느낌이라 웃김",
      replies:["맞아요 감정이입 대신해주는 느낌"] },
    { text:"이 정도면 저장은 필수고 화면 캡처도 필수임",
      replies:["갤러리가 이 소설 스샷으로 채워지는 중"] },
    { text:"진짜 이 조합 처음 보는데 왜 이렇게 잘 어울리지",
      replies:["그니까요 안 어울릴 것 같은데 찰떡임"] },
  ];
  ...
  const SCENE_POOLS = {
    "1화": [
      ...
      { text:"복도에서 스치듯 본 것만으로 이렇게 조진다고요 저부터 조졌습니다",
        replies:["저도 첫 화부터 마음의 준비를 못했어요","이 정도로 조질 줄 몰랐음 저도 당함"] },
      { text:"한서준 눈 내리깔고 인사 연습하는 거 상상하니까 너무 짠하면서 웃김",
        replies:["귀여워서 못 참겠음 저 신입 좀 도와주고 싶다","짠한데 웃긴 거 뭔지 알 것 같아요"] },
    ],
    "2화": [
      ...
      { text:"부회장 자리에서 야식 챙겨주는 상사 어디 없나요 진지하게 구직 중입니다",
        replies:["채용공고 뜨면 저도 지원하겠습니다","현실에 없어서 더 애타는 캐릭터임"] },
      { text:"‘내 사람이 굶는 건 못 봐서’ 이 대사 캡처해서 폰 배경화면 해놨어요",
        replies:["저는 프사로 해놨습니다 이거","이 대사 하나로 오늘 하루 버팀"] },
    ],
    "3화": [
      ...
      { text:"손목 잡는 장면 세 번째 다시보기 중입니다 일하다가도 생각남",
        replies:["저는 다섯 번째인데 아직도 심장 떨림","업무 효율 이 소설 때문에 반토막났어요"] },
      { text:"타라고 했다 이 대사 왜 이렇게 설레는 거야 진짜 반칙이잖아",
        replies:["저도 그 짧은 대사에 무너졌습니다","반말 명령체 이렇게 설렌 적 처음"] },
      { text:"카톡으로 미쳤냐 축하해야되냐 도망쳐야되냐 이 반응 완전 제 생각이랑 똑같아서 놀람",
        replies:["저도 읽으면서 똑같이 생각했어요 ㅋㅋㅋ","현실 반응 그 자체라 웃겼어요"] },
    ],
  };
